define(["sitecore", "/-/speak/v1/experienceprofile/DataProviderHelper.js", "/-/speak/v1/experienceprofile/CintelUtl.js"], function (sc, providerHelper, cintelUtil) {
    ...
    var app = sc.Definitions.App.extend({
        ...
        loadPanel: function () {
            var panelId = $("[data-sc-id='KeyInteractionsTabControl'] > .tab-content > .active .sc-load-on-demand-panel").data("sc-id");
        ...
        showDefaultTab: function () {
            var firstTabId = this.KeyInteractionsTabControl.get(selectedTabProperty);
            var urlTabId = this.getTabIdFromUrl();

            if (urlTabId && urlTabId != firstTabId) {
                this.KeyInteractionsTabControl.set(selectedTabProperty, urlTabId);
            } else {
                this.loadPanel();
            }
        },
        ...
        processTabs: function () {
            this.KeyInteractionsTabControl.on("change:" + selectedTabProperty, function (tabControl, selectedTab) {
                this.loadPanel();
            }, this);
